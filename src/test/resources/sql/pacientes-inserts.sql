insert into pacientes (id, ativo, nome, cpf, email, telefone, logradouro, numero, complemento, bairro,
                       cidade, uf, cep)
values (nextval('pacientes_id_seq'), true, 'Adriana Marina Lima', '82303783399', 'adriana_marina_lima@abareias.com.br',
        '85989615314', 'Rua Santa Filomena', '473', 'Apto 102', 'Centro', 'Abaiara', 'CE', '62500000');

insert into pacientes (id, ativo, nome, cpf, email, telefone, logradouro, numero, complemento, bairro,
                       cidade, uf, cep)
values (nextval('pacientes_id_seq'), true, 'Vinicius Henrique Araújo', '30244511373', 'vinicius.henrique@odebrecht.com',
        '85982722865', 'Rua B', '361', '', 'Passaré', 'Fortaleza', 'CE', '60862504');
